    ...
    <div class="container">
        <h3>Comment</h3>
          <table class="tbl" border="1" style="border-collapse:collapse; width:630px;">
            <thead>
               <tr>  
                <td width='150px'>Comment Author</td>
                <td><input type='text' name='comment' value='<?=$comment?>'></td>
               </tr>
            </thead>
            <tbody>
               <tr>
                <td colspan="2"><textarea row="3" cols="75" style="border:none; pointer-events:none; appearance: none;"></textarea></td>
              </tr>
            </tbody>
          </table>
          <br>
          ...
          <table class="tbl" border="1" style="border-collapse:collapse; width:630px;">
            <thead>
              <tr>
                <td colspan="2">Comment List</td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td><input type='text' name='comment_cnt' style='50px' value='<?=$comment_cnt?>'></td>
                <td><textarea row='3' cols='50' style='border:none; pointer-events:none; appearance: none;'></textarea></td>
                <td><input type='text' name='comment_author' value='<?=$comment_author?>'></td>
              </tr>
            </tbody>
          </table>
        </div>
