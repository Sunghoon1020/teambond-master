...
.footer{
    ...
    <h2 style="text-align:center;">Edit Profile</h2>
            ...
            echo "<input type='email' name='user_email' style='border:none;border-bottom:1px solid black;' id='email' value='{$load_user_email}' class=form-control >";
            echo "</div>";
            echo "<div>";
            ...
            echo "</div>";
            echo "<button type='submit' name='submit' id='btn-login' class='btn btn-custom btn-lg btn-block'>Save</button> &nbsp;";
            echo "&nbsp<a href='main.php?user_name={$user_name}'><button type='button' name='back' id='btn-login' style='padding-left:15px;' class='btn btn-custom btn-lg btn-block'>Back</button>";
            echo "</div>";
            }?>
      </form>
